"""
Quantum Path for Qiskit V2.0 Architecture.
...
from qiskit_v2.quantum_circuit import QiskitQuantumCircuit, QuantumMeasurement
...
class QuantumPath(nn.Module):
    ...
    def __init__(
        ...
        # Qiskit variational quantum circuit (measurement built-in via EstimatorQNN)
        self.circuit = QiskitQuantumCircuit(
            n_qubits=n_qubits,
            n_layers=n_layers
        )
        
        # Measurement (no-op for Qiskit, kept for API compat)
